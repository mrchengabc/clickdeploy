...
menu_performance() {
    while true; do
        ...
        echo "=========================================="
        echo "1) Jalankan Optimasi Performa & Auto-Tuning Server"
        echo "   (Redis, OPcache, Gzip, Limit PHP-FPM, MariaDB, WP-Cron)"
        echo "2) Kembali ke Menu Utama"
        echo "=========================================="
        read -p "Pilih opsi [1-2]: " sub_opt
        
        case $sub_opt in
            1) run_module "performance_tuning.sh" ;;          # <-- Menjalankan modul gabungan lengkap
            2) break ;;
            *) echo "Pilihan tidak valid!"; sleep 1 ;;
        esac
    done
